...
# stoch_dtb.plot_T_Yk(["H2", "H2O", "NH3"])
...
# nb_inlet = 2
# stoch_dtb.plot_indiv_traj(nb_inlet, "Temperature")
...
var2 = "NH3"
var_color = "Prog_var"
stoch_dtb.plot_animation(var1, var2, var_color, iterations=None, step=10, interval=300, save_path=None, fps=5)
